...
public class LocationDao implements AbstractDao<Long, Location> {
    ...
    @Override
    public Location createEntity(ResultSet set) throws DaoException {
        Location location = null;
        try {
            ...
            location = LocationFactory.getInstance().create(location_id, location_latitude, location_longitude, address);
