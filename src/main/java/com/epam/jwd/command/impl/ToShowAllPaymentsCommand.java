...
public class ToShowAllPaymentsCommand implements Command {
    @Override
    public CommandResult execute(HttpServletRequest servletRequest) {
        ...
        try {
            ...
            commandResult = new CommandResult("WEB-INF/jsp/admin/show_all_payments.jsp", CommandResult.ResponseType.FORWARD);
