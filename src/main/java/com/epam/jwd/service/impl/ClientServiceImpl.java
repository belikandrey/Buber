...
public class ClientServiceImpl implements ClientService {
    ...
    public List<BankCard> findAllClientCard(String login) throws ServiceException {
        try {
            ...
            throw new ServiceException("Bank Card DAO provides exception in service");
        }
    }
    ...
    public Optional<Location> findLocationByLatitudeLongitude(Location location) throws ServiceException {
        try {
            ...
            throw new ServiceException("Location DAO provides exception in service");
        }
    }
    ...
    @Override
    public Optional<Client> findByLogin(String login) throws ServiceException, ValidationException {
    ...
    public void updatePhoneNumber(Long id, String newNumber) throws ServiceException {
        try {
    ...
    public boolean addBankCard(BankCard bankCard) throws ValidationException, ServiceException {
        ...
        try {
            ...
            throw new ServiceException("Bank card DAO provides exception in service : "+e);
        }
    }
    ...
    public boolean addClient(Client client) throws ServiceException, ValidationException {
        ...
        try {
            ...
            throw new ServiceException("User or client DAO provides exception in service : "+exception);
        }finally {
            try {
