        ...
        <form action="client?command=add_bank_card" method="post">
            <div class="row">
                ...
                <div style="padding-left: 25%;" class="col col-lg-9">
                    <h2 style="padding-left: 30%;">Card info</h2>
                    <div class="mb-3">
                        <label for="cardNumber" class="form-label">Card number</label>
                        <input type="text" class="form-control" id="cardNumber" name="cardNumber" aria-describedby="card_numberHelp">
                        <div style="color: red; font-weight: 500;" id="card_numberHelp" class="form-text">Enter card number without spaces(4255200053071799).</div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div style="color: red; font-weight: 500;" id="card_dateHelp" class="form-text">Enter card date(08/21, 11/23).</div>
                    </div>
                    <div class="mb-3">
                        <label for="cardCsc" class="form-label">Card csc</label>
                        <input type="text" class="form-control" id="cardCsc" name="cardCsc" aria-describedby="card_cscHelp">
                        <div style="color: red; font-weight: 500;" id="card_cscHelp" class="form-text">Enter card csc(123, 435, 974).</div>
                    </div>
                    <br>
