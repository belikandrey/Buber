...
<div>
    <form method="post" action="home?command=driver_login">
...
<div>
    ...
    <p><a href="home?command=to_driver_signin"><fmt:message key="sign_in"/> !</a></p>
</div>
<br>
<div>
    <p><a href="home?command=to_driver_forgot_password"><fmt:message key="forgotPassword"/> ?</a></p>
</div>
